...
export default function Home() {
  return (
    <section className="">
      <div className="text-4xl font-bold">Cabinet du docteur Dubois</div>
      <div className="card w-full">
        ...
        <div className="card card-body">
            ...
            <p className="text-justify prose-lg">
                Situé au cœur de la ville, le cabinet du Docteur Dubois vous accueille dans un environnement moderne,
                apaisant et équipé des dernières technologies pour vous offrir des soins dentaires de haute qualité.
            </p>
            <p className="text-justify prose-lg">
                Le Dr Dubois, chirurgien-dentiste expérimenté et à l’écoute, met un point d’honneur à proposer des traitements personnalisés, adaptés aux besoins de chaque patient, qu’il s’agisse de soins préventifs, de soins conservateurs, d’esthétique dentaire ou de chirurgie.
            </p>
            <p className="text-justify prose-lg">
